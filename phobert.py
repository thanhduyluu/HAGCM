...
from transformers import RobertaModel  # Sử dụng RobertaModel cho PhoBERT
from torch_geometric.nn import GCNConv

class HAGCM(nn.Module):
    def __init__(self, bert_model_name='vinai/phobert-base', hidden_dim=128, gnn_output_dim=64):
        super(HAGCM, self).__init__()
        # Sử dụng PhoBERT để mã hóa văn bản
    ...
    def forward(self, input_ids, attention_mask, edge_index, label_embeddings):
        # Bước 1: Mã hóa văn bản bằng PhoBERT (RobertaModel)
